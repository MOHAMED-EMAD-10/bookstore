    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            <div class="navbar-header">
                <!-- Navbar Header--><a href="{{ asset('dashboard/') }}index.html" class="navbar-brand">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1"
                        href="{{ asset('dashboard/') }}http://example.com" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
                            ...
                            <div class="profile"><img src="{{ asset('dashboard/img/avatar-3.jpg') }}" alt="..."
                                    class="img-fluid">
                            ...
                            <div class="profile"><img src="{{ asset('dashboard/img/avatar-2.jpg') }}" alt="..."
                                    class="img-fluid">
                            ...
                            <div class="profile"><img src="{{ asset('dashboard/img/avatar-1.jpg') }}" alt="..."
                                    class="img-fluid">
                            ...
                            <div class="profile"><img src="{{ asset('dashboard/img/avatar-5.jpg') }}" alt="..."
                                    class="img-fluid">
                ...
                <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#"
                        ...
                        class="nav-link language dropdown-toggle"><img
                            src="{{ asset('dashboard/img/flags/16/GB.png') }}" alt="English"><span
                            class="d-none d-sm-inline-block">English</span></a>
                    <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#"
                            class="dropdown-item"> <img src="{{ asset('dashboard/img/flgs/16/DE.png') }}"
                                alt="English" class="mr-2"><span>German</span></a><a rel="nofollow"
                            href="#" class="dropdown-item"> <img
                                src="{{ asset('dashboard/img/flags/16/FR.png') }}" alt="English"
