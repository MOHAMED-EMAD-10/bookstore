    ...
    <div class="col-lg-12">
        <div class="block">
            <div class="block-body">
                <div class="title"><strong>Edit Book</strong></div>
                                ...
                                <div class="block">
                                    <div class="block-body">
                                        <form class="form-horizontal"
                                            action="{{ route('dashboard.books.update', $book->slug) }}" method="POST"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="title" value="{{ $book->title }}"
                                                        id="inputHorizontalSuccess" type="text"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="author" value="{{ $book->author }}"
                                                        id="inputHorizontalWarning" type="text"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="{{ $book->quantity }}" id="inputHorizontalWarning"
